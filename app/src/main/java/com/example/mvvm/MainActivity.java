...
import com.example.AddEditNoteActivity;
import com.example.mvvm.adapter.NoteAdapter;
import com.example.mvvm.entity.Note;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noteViewModel.getAllNotes().observe(this, new Observer<List<Note>>() {
            @Override
            public void onChanged(List<Note> notes) {//this will be called when ever live data changes in our data
                    //update recyclerview
